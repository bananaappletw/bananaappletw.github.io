...
- **SEO**: Sitemap generation, dynamic OG images, RSS feeds, and `/llms.txt` (llmstxt.org format, generated by `src/pages/llms.txt.ts` from the same helpers as the feed)
