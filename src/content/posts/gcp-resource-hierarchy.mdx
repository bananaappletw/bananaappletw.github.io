...
description: "The same 200-person, 10-team problem on GCP — folders, projects, IAM inheritance and a single login page."
tags: ["gcp"]
---
...
subgraph A [Team A Google Group] A1[Team A production Google Group] A2[Team A
staging Google Group] end ```
