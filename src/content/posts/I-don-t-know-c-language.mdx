...
pubDatetime: 2016-04-21T21:12:00.000Z
description: "Stack versus read-only section when a string is an array or a pointer, and what changes again when the same distinction is a function argument."
tags: ["c", "computer science", "archive"]
---
