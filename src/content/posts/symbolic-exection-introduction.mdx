...
pubDatetime: 2016-02-23T09:19:00.000Z
description: "What symbolic execution is: running a program on symbolic inputs to work out which inputs reach which part of it."
tags: ["archive"]
---
...
The program would then proceed with the multiplication and assign λ _ 2 to z. When reaching the if statement, it would evaluate λ _ 2 == 12.
