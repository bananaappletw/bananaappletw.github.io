...
pubDatetime: 2016-03-31T02:02:00.000Z
description: "How glibc's MINSIZE macro rounds a size up to an alignment boundary with & and ~, found while tracing malloc.c."
tags: ["linux kernel", "computer science", "archive"]
---
