...
description: "Passing an RTX 2080 Ti through to a KVM guest on Ubuntu 20.04: enabling IOMMU, checking the groups, and binding the card to VFIO."
tags: ["kvm", "cloud-init", "vfio", "GPU"]
---
